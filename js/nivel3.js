...
function tareaOperadores(operador,num1,num2){
    console.log(operador(num1,num2));
}
tareaOperadores(substract,1,2);
*/
/*
    Introducción
    ============
...
function tarea1(){
    ...
    console.log(nuestroTitulo.innerText = "Hola argentina");
}
...
const nodoImagen = document.querySelector('header');
const nuevaImagen = document.createElement('img');
nuevaImagen.src = "img/kittens.jpeg";
nuevaImagen.alt = 'Imagen de un gato y un bebe';
nodoImagen.appendChild(nuevaImagen); 
...
$botonIngresar.onclick = function(e){
    ...
    let resultado;
    if($edadUsuario >=18){
        resultado = 'Entra al bar';
    }else{
        resultado = 'No entra al bar';
    }
